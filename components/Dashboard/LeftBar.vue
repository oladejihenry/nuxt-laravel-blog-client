        ...
        >
          ...
          >
            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none">
              ...
              <li class="items-center">
                <div @click="dropCat" type="button" class="click-drop text-xs uppercase py-3 font-bold block text-blueGray-700 hover:text-blueGray-500" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">        
                  <i class="fa fa-book mr-2 text-sm text-blueGray-300" aria-hidden="true"></i>
                  Categories
                  <i class="fa fa-caret-down mr-2 text-sm" aria-hidden="true"></i>   
                </div>
                <ul class="py-2 space-y-2" v-if="showDrop2">
                  <li class="items-center">
                    <NuxtLink to="/categories" class="text-xs uppercase py-3 font-bold block text-blueGray-700 hover:text-blueGray-500">
                      <i class="fa fa-tasks mr-2 text-sm" aria-hidden="true"></i>
                      All Categories
                    </NuxtLink>
                  </li>
                  <li>
                    <NuxtLink to="/categories/create" class="text-xs uppercase py-3 font-bold block text-blueGray-700 hover:text-blueGray-500">
                      <i class="fa fa-plus mr-2 text-sm" aria-hidden="true"></i>
                      Create Category
                    </NuxtLink>
                  </li>
